...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20220806041730_ChangeColumnType")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.OrderRelatedEntities.DeliveryMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.OrderRelatedEntities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.OrderRelatedEntities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.OrderRelatedEntities.Order", b =>
                {
                    b.HasOne("Core.Entities.OrderRelatedEntities.DeliveryMethod", "DeliveryMethod")
                        .WithMany()
                    ...
                    b.OwnsOne("Core.Entities.OrderRelatedEntities.Address", "ShippingAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("Core.Entities.OrderRelatedEntities.OrderItem", b =>
                {
                    ...
                    b.HasOne("Core.Entities.OrderRelatedEntities.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
